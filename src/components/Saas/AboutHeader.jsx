        ...
        <div className="row justify-content-center">
          <div className="col-lg-8">
            <div className="info">
              ...
              <p>
                { rtl ? 'يساعدك كليكاتك على توحيد هوية علامتك التجارية من خلال جمع وتخزين ' : 'Iteck helps you unify your brand identity by collecting, storing and distributing' } <br /> { rtl ? 'وتوزيع رموز وأصول التصميم - تلقائيًا.' : 'design tokens and assets — automatically.' }
              </p>
            </div>
          </div>
